...
<html lang="en">
  <head>
	...
	?>
	  ...
	  <?php $viewcopier = mysql_query("select * from items where status='pending' group by itemtitle order by time asc"); ?>
          <section class="wrapper">
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Pending Products</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Pending Products</li>
                           ...
                           <tbody>
							 ...
							 <?php $i = 1; while($view = mysql_fetch_assoc($viewcopier)) { ?>
                              <tr>
                                ...
                                <td>
                                  <div class="btn-group" >
                                      <a class="btn btn-primary" href="pendingproducts.php?viewproduct=<?php echo"$view[itemtitle]"; ?>" data-toggle='tooltip' title='View Product'> View Details <i class="icon_plus_alt2"></i></a><br /><br>
                                      <a class="btn btn-success" href="pendingproducts.php?recommend=<?php echo"$view[itemtitle]"; ?>" data-toggle='tooltip' title='Publish'> Publish Product <i class="icon_check_alt2"></i></a><br /><br>
                                      <a class="btn btn-danger" href="pendingproducts.php?deleteitem=<?php echo"$view[itemtitle]"; ?>" data-toggle='tooltip' title='Delete Item'>Reject <i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
							 <?php } ?>
