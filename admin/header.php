  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            <div class="toggle-nav">
                <div class="icon-reorder tooltips" data-original-title="Toggle Navigation" data-placement="bottom">MENU</div>
            </div>

            <!--logo start-->
            <a href="index.php" class="logo">VM ADMIN</a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="login.php?cid=1212"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
